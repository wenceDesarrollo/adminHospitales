          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                  <li><a href="factura.jsp">Recibo de Insumos en Almac&eacute;n</a></li>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p>
          ...
          <a class="btn btn-lg btn-primary" href="factura.jsp"  role="button">Recibo de Insumos en Almac&eacute;n</a>
          <a class="btn btn-lg btn-primary" href="entregas.jsp" role="button">Entrega a Proveedores</a>
          <a class="btn btn-lg btn-primary" href="exist.jsp" role="button">Existencias en CEDIS</a>
          <a class="btn btn-lg btn-primary" href="rep.jsp" role="button">Reporteador</a>
