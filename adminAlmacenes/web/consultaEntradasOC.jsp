...
<%java.text.DateFormat df2 = new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm:ss"); %>
<%
...
<html lang="en">
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><b>Consulta Ingresos a OC</b></a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class=""><a href="consultaEntradasISEM.jsp">Entradas Rep ISEM</a></li>
                        <li class="active"><a href="consultaEntradasOC.jsp">Entradas OC</a></li>
        ...
        <div class="container" style="padding-top: 60px">
            ...
            <h1>Consulta Ingresos a Órdenes de Compra</h1>
            <div class="row">
                <form action="consultaEntradasOC.jsp" method="post">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" name="usuario" onchange="this.form.submit();">
                            ...
                            <%
                                try {
                                    ...
                                    con_saa.conectar();
                                    ResultSet rset = con_saa.consulta("select * from tb_entradasisem where F_Correcto = '1' group by F_Usuario order by (F_Id+0) desc");
                                    while (rset.next()) {
                        ...
                        <div class="col-sm-2">
                            <a href="consultaEntradasOC.jsp" class="btn btn-default" >Todos</a>
                        </div>
                </form>
            </div>
                    ...
                    <tbody>
                        <%
                            try {
                                Calendar calendar = Calendar.getInstance();
                                con_saa.conectar();
                                ResultSet rset = con_saa.consulta("select * from tb_entradasisem where F_Correcto = '1' and F_Usuario like '%" + usuario + "%' order by (F_Id+0) desc");
                                while (rset.next()) {
                                    /*calendar.setTime(df.parse(rset.getString(4)));
                                     calendar.add(Calendar.HOUR, 6);
                                     Date hora = calendar.getTime();*/
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td><%=df2.format(df.parse(rset.getString(2)))%></td>
