...
<html lang="en">
  ...
  <div class="container">
      <div class="row" >
          ...
          <div class="col-md-4"><h1>INGRESO M&Eacute;DICOS</h1></div>
          <div class="col-md-4"></div>
      </div>
      ...
      <form name ="form" id="forma-login" class="marco" action="/CensosVer/login" method="post" >
       ...
       <div class="row">
        ...
        <div class="col-md-8"><h2>Validar M&eacute;dico</h2></div>
 ...
 <div class="input-group">
  <span class="input-group-addon"><label class="glyphicon glyphicon-user"></label>
     ...
     <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Introduzca Nombre de Usuario M&eacute;dico">
</div>
<div class="input-group">
  <span class="input-group-addon"><label class="glyphicon glyphicon-hand-right"></label>
  </span>
  
    <input type="password" name="pass" id="pass" onkeyup="this.form.hash.value = MD5(this.form.pass.value);" class="form-control"  placeholder="Introduzca Contrase&ntilde;a V&aacute;lida de M&eacute;dico">
</div>
