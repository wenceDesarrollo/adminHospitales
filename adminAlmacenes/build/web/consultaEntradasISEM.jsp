    ...
    <body>
        ...
        <div style="padding-top: 60px;">
            ...
            <div style="width: 1200px; margin: auto">
                ...
                <a class="btn btn-default btn-sm" href="http://166.78.128.202:8080/webGNKL/menuToluca.jsp">Regresar</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <h3>Conteo de Entradas por Usuario</h3>
                        <table class="table table-bordered table-striped table-responsive">
                            ...
                            %>
                            <tr>
                                <td><%=rset.getString(1)%> <%=rset.getString(2)%></td>
