...
<html>
    <head>
        ...
        <!---->
        <title>Existencias en Almac&eacute;n</title>
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="">Entrega a Proveedores</a></li>
                                    <li><a href="">Existencias en CEDIS</a></li>
        ...
        <div class="container">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Ingresos en el Almac&eacute;n</h3>
                </div>
