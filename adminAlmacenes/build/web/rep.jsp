        ...
        <div class="container">
            <div class="panel panel-primary">
                ...
                <div class="panel-body ">
                    <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="rep.jsp">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <label for="Nombre" class="col-sm-2 control-label">Orden de Compra:</label>
                                <div class="col-xs-3">
                                    <input type="text" class="form-control" id="Nombre" name="Nombre" maxlength="60" placeholder="Ingrese Orden de Compra" value="" onKeyPress="return tabular(event, this)" />
                                </div>
                                <label for="Nombre" class="col-sm-2 control-label">Por Clave:</label>
                                <div class="col-xs-3">
                                    <input type="text" class="form-control" id="Nombre" name="Nombre" maxlength="60" placeholder="Ingrese Clave de Insumo" value="" onKeyPress="return tabular(event, this)" />
                                </div>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label for="FecFab" class="col-md-2 control-label">Por Fecha:</label>
                                <div class="col-sm-2">
                                    <input data-date-format="dd/mm/yyyy" readonly="readonly" type="text" class="form-control" id="FecFab" name="FecFab" placeholder="Fecha de Ingreso" onKeyPress="LP_data();
                                            anade(this);
                                            return tabular(event, this)" maxlength="10" />
                                </div>
                                <div class="col-sm-2">
                                    <input data-date-format="dd/mm/yyyy" readonly="readonly" type="text" class="form-control" id="FecFab" name="FecFab" placeholder="Fecha de Salida" onKeyPress="LP_data();
                                            anade(this);
                                            return tabular(event, this)" maxlength="10" />
                                </div>
                                <div class="col-sm-2">
