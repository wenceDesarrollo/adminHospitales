...
java.text.DateFormat df3 = new java.text.SimpleDateFormat("dd/MM/yyyy"); 
    ...
    if (Proveedor == null) {
      ...
      out.write("                        <h4 class=\"col-sm-1\">Proveedor</h4>\n");
      ...
      out.write("                            </select>\n");
      out.write("                        </div>\n");
      out.write("                        <h4 class=\"col-sm-2\">Fecha de Entrega</h4>\n");
      ...
      out.write("                        <a class=\"btn btn-primary\" href=\"historialOC.jsp\"><span class=\"glyphicon glyphicon-refresh\"></span></a>\n");
      out.write("                    </form>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      ...
      out.write("                                <td class=\"text-center\">Ver OC</td>\n");
      out.write("                                <td class=\"text-center\">Ver Rechazo</td>\n");
      out.write("                                <td class=\"text-center\">Ver Docto</td>\n");
      out.write("                            </tr>\n");
      out.write("                        </thead>\n");
      out.write("                        <tbody>\n");
      out.write("                            ");
      ...
      out.write("</td>\n");
      out.write("                                <td><button class=\"btn btn-success\" onclick=\"javascript:window.open('verOrdenCompra.jsp?NoCompra=");
      out.print(rset.getString(1));
      out.write("', '', 'width=600,height=400,left=50,top=50,toolbar=no')\"><span class=\"glyphicon glyphicon-search\"></span></button></td>\n");
      out.write("                                        ");
if (imagen.equals("")) {
      out.write("\n");
      out.write("                                <td>&nbsp;</td>\n");
      ...
      out.write("\n");
      out.write("                                <td><a href=\"Rechazo/");
      out.print(imagen);
      out.write(".jpg\"  rel=\"lightbox\" target=\"_black\"><button class=\"btn btn-success\"><span class=\"glyphicon glyphicon-picture\"></span></button></a></td>\n");
      out.write("                                            ");
      ...
      out.write("                                    ");
                                        ...
                                        System.out.println("SELECT F_Ima FROM TB_ImaOC where F_OrdCom = '" + rset.getString(1) + "'");
                                        rset3 = con.consulta("SELECT F_Ima FROM TB_ImaOC where F_OrdCom = '" + rset.getString(1) + "'");
                                        while (rset3.next()) {
                                            imaOC = rset3.getString("F_Ima");
                                    
      out.write("\n");
      out.write("                                    <a class=\"example-image-link\" href=\"imagenes/OC/");
      out.print(imaOC);
      out.write(".jpg\" data-lightbox=\"example-1\"><img src=\"imagenes/OC/");
      out.print(imaOC);
      out.write(".jpg\" width=\"100%\" /></a>\n");
      out.write("                                        ");
